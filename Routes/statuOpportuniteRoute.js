...
router.post('/newStatuOpportunite', async(req,res)=>{
...
router.post('/modifierStatuOpportunite/:id', async(req,res)=>{
   ...
   // const {error}=validateStatuOpportunite(req.body)
    ...
    req.body.societeRacine = undefined
...
router.post('/deleteStatuOpportunite/:id', async(req,res)=>{
 ...
 */
 ...
 router.post('/listStatuOpportunites', async(req,res)=>{
