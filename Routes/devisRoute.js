 ...
 *
 */
router.post('/newDevis', async(req,res)=>{
...
router.post('/modifierDevis/:id', async(req,res)=>{
 ...
 */
router.post('/deleteDevis/:id', async(req,res)=>{
 ...
 */
 ...
 router.post('/listDevis', async(req,res)=>{
