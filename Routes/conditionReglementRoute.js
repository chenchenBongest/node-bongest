...
router.post('/newConditionReglement', async(req,res)=>{
...
router.post('/modifierConditionReglement/:id', async(req,res)=>{
...
router.post('/deleteConditionReglement/:id', async(req,res)=>{
 ...
 */
 ...
 router.post('/listConditionReglements', async(req,res)=>{
