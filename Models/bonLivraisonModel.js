...
async function getNumeroAutomatique(idSociete, exercice){
    ...
    let lastDoc = (await BonLivraison.find({societe:idSociete, exercice:exerciceString}).sort({_id: -1}).limit(1))[0];
    ...
    if(lastDoc != undefined){
        ...
        return {numero:"BL"+exerciceString+"-"+somme, num:num}
    }else{
        return {numero:"BL"+exerciceString+"-00000001", num:1}
    }
