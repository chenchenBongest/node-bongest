...
async function getNumeroAutomatique(idSociete, exercice){
    ...
    let lastDoc = (await BonRetourClient.find({societe:idSociete, exercice:exerciceString}).sort({_id: -1}).limit(1))[0];
    ...
    if(lastDoc != undefined){
        ...
        return {numero:"BRC"+exerciceString+"-"+somme, num:num}
    }else{
        return {numero:"BRC"+exerciceString+"-00000001", num:1}
    }
